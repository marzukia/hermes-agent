...
KANBAN_GUIDANCE = (
    ...
    "When the board has a stage chain, a plain `kanban_complete` hands the "
    "task to the next stage automatically (it moves to that stage's profile "
    "as `ready` rather than `done`); on the final stage, or a board with no "
    "stage chain, it marks the task done.\n"
